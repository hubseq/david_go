...
mi_template_json = {'module_version': '00.00.00', 'program_name': 'david_go', 'program_subname': '', 'program_version': '0.11.5', 'compute': {'environment': 'aws', 'language': 'Python', 'language_version': '3.7', 'vcpus': 2, 'memory': 6000}, 'program_arguments': '-name default', 'program_input': [{'input_type': 'file', 'input_file_type': 'TXT', 'input_position': -1, 'input_prefix': '-i'}, {'input_type': 'file', 'input_file_type': 'CSV', 'input_position': -1, 'input_prefix': '-i'}, {'input_type': 'file', 'input_file_type': 'TAB', 'input_position': -1, 'input_prefix': '-i'}], 'program_output': [{'output_type': 'folder', 'output_file_type': '', 'output_position': 0, 'output_prefix': '-o'}], 'alternate_inputs': [], 'alternate_outputs': [], 'defaults': {"output_file": ""}}
